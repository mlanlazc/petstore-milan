package io.github.mlanlazc.http.util;

import static io.github.mlanlazc.http.util.HttpArgumentConverter.toStringArgument;

import io.github.mlanlazc.exceptions.ArgumentCannotBeNullException;
...
public class HttpHeaders {
  ...
  public static class Builder {
     ...
     */
    public Builder addRequiredHeader(String name, Object value) throws ArgumentCannotBeNullException {
      if (value == null) {
